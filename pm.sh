pm::install() {
    ...
    *)       echo "pm::install: unknown package manager" >&2; return 1 ;;
    esac
}
...
pm::sync() {
    ...
    *)       echo "pm::sync: unknown package manager" >&2; return 1 ;;
    esac
}
...
pm::update() {
    ...
    nix)     nix-env -u ;;
    *)       echo "pm::update: unknown package manager" >&2; return 1 ;;
    esac
}
...
pm::uninstall() {
    ...
    *)       echo "pm::uninstall: unknown package manager" >&2; return 1 ;;
    esac
}
...
pm::search() {
    ...
    *)       echo "pm::search: unknown package manager" >&2; return 1 ;;
    esac
}
